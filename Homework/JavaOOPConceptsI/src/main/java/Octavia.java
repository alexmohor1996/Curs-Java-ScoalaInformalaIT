public class Octavia extends Skoda{
    ...
    final int fuelTankSize = 150;
    String fuelType = "Diesel";
    int gears = 5;
    final double consumptionPer100KM = 9.5;
    double availableFuel = 150;
    int tireSize;
    String chassisNumber;

    Octavia(double fuel, String chassis)
    {
    ...
    public void start()
    {
        System.out.println("Octavia has started");
    }

    public void drive(double km)
    {
        System.out.println("Octavia is driving " + km + " kilometers");
    }

    public void stop()
    {
        System.out.println("Octavia has stopped");
    }
    ...
    public void shiftGear(int gear)
    {
        ...
        if (gear == 1)
        {
            System.out.println("Octavia is in the first gear");
            ConsumptionTrackingBetweenStartAndStop(1);
        }
        else if (gear == 2)
        {
            System.out.println("Octavia is in the second gear");
            ConsumptionTrackingBetweenStartAndStop(2);
        }
        else if (gear == 3)
        {
            System.out.println("Octavia is in the third gear");
            ConsumptionTrackingBetweenStartAndStop(3);
        }
        else if (gear == 4)
        {
            System.out.println("Octavia is in the fourth gear");
            ConsumptionTrackingBetweenStartAndStop(4);
        }
        else if (gear == 5)
        {
            System.out.println("Octavia is in the fifth gear");
    ...
    public void ConsumptionTrackingBetweenStartAndStop(int gear)
    {
        ...
        System.out.println("Octavia is consuming " + cons);
    }
