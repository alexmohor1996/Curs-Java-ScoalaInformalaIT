public class Logan extends Dacia{
    ...
    public void start()
    {
        System.out.println("Logan has started");
    }

    public void drive(double km)
    {
        System.out.println("Logan is driving " + km + " kilometers");
    }

    public void stop()
    {
        System.out.println("Logan has stopped");
    }
    ...
    public void shiftGear(int gear)
    {
        ...
        if (gear == 1)
        {
            System.out.println("Logan is in the first gear");
            ConsumptionTrackingBetweenStartAndStop(1);
        }
        else if (gear == 2)
        {
            System.out.println("Logan is in the second gear");
            ConsumptionTrackingBetweenStartAndStop(2);
        }
        else if (gear == 3)
        {
            System.out.println("Logan is in the third gear");
            ConsumptionTrackingBetweenStartAndStop(3);
        }
        else if (gear == 4)
        {
            System.out.println("Logan is in the fourth gear");
            ConsumptionTrackingBetweenStartAndStop(4);
        }
        else if (gear == 5)
        {
            System.out.println("Logan is in the fifth gear");
    ...
    public void ConsumptionTrackingBetweenStartAndStop(int gear)
    {
        ...
        System.out.println("Logan is consuming " + cons);
    }
